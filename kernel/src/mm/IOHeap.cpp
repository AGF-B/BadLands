...
void IOHeap::Coalesce(Metadata* current) {
...
void* IOHeap::Allocate(const size_t size) {
    return Allocate(size, DEFAULT_ALIGNMENT);
}

void* IOHeap::Allocate(const size_t size, const size_t alignment) {
