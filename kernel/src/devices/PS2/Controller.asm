...
global InitializePS2Controller
global IdentifyPS2Port1
global SendBytePS2Port1
global RecvBytePS2Port1
...
; reset device on the first PS/2 port, disable interrupts to avoid receiving IRQ1
    cli
    call ResetPS2Port1
    ret
...
ResetPS2Port1:
;; check if the device can identify, if not, it is not even worth resetting it
    call IdentifyPS2Port1
    cmp eax, 0xFFFF
    jle .L1
    mov eax, PS2_ERROR
    ret
